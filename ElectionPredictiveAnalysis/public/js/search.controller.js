...
//          raja
    ...
    controller.select = function (tweet) {
      ...
      console.log(controller.data.selected);
      $("#selected-tweet").text("");
      $("#selected-tweet-raw").removeClass("prettyprinted").text(angular.toJson(tweet, 2));
      prettyPrint();
      var tweetText=tweet.message.body;
      console.log(tweetText);
      searchService.naturalLanguageProcessing(tweetText).then(
    	        function (response) {
    	        	  controller.data.nltk=response;	
    	        	   console.log("nltk is");
    	        	      console.log(controller.data.nltk);
    	        });
      
    
   
      console.log("stem");
      console.log(controller.data.nltk.stem);
    ...
    controller.change=function(party){
...
var queryRepublican = [
                      
                      {
                        ...
                        input: 'select',
                        description: 'Matches Tweets with the hashtag #hashtag.',
                        values: queryRepublicanCandidates,
                        operators: ['equal', 'not_equal'],
                        data: convertSimpleSelectHashtag
                      },
